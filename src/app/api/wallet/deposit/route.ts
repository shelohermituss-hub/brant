...
/**
 * Simule un dépôt MonCash -> wallet Sòlid : pas de vraie intégration
 * MonCash disponible (même limite que /api/moncash/simulate-payment),
 * donc ce harnais applique directement la transaction. À remplacer par
 * un vrai callback webhook le jour où les credentials marchand existent.
 */
