...
| Icônes PWA (installation écran d'accueil, splash Android, favicon) | `public/logos/solid-mark-source.png` (master 1024×1024, MCP Higgsfield, `nano_banana_flash`) + dérivés `public/icons/icon-192.png`, `icon-512.png`, `icon-maskable-512.png`, `apple-touch-icon.png`, `src/app/favicon.ico` | ⚠️ Exception autorisée | **Dérogation ponctuelle à la règle "jamais généré par IA"**, explicitement demandée et confirmée par l'utilisateur après qu'on l'ait signalée (juillet 2026) — motif : aucun logo officiel n'existe, et les icônes d'app nécessitent un visuel fort avant toute installation possible. Anneaux entrelacés stylisés, fond vert lime de marque (`--color-green`, normalisé en post-traitement), symbole encre foncée. Une régénération intermédiaire (variante 3 cercles) a été écartée car elle évoquait un symbole de danger biologique. À remplacer si un logo officiel Sòlid est fourni un jour — ne pas réutiliser cette dérogation comme précédent pour d'autres visuels de marque. |
